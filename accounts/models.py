...
class User(AbstractUser):
    ...
    CLOTHES_SIZE = ('xs', 'XS'), ('sm','S'), ('dm', 'M'), ('lg', 'L'), ('xlg', 'XL'),('xxlg', 'XXL'),('xxxlg', 'XXXL'),
    ...
    shoeSize = models.CharField(max_length=10, choices=CLOTHES_SIZE)
    topSize = models.CharField(max_length=10, choices=CLOTHES_SIZE)
    bottomSize = models.CharField(max_length=10, choices=SHOE_SIZE)
